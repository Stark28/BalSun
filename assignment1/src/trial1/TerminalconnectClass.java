...
public class TerminalconnectClass{
	
public static ArrayList ter2fn(Document doc1, ArrayList TerminalconnectList)
{
   ...
   // TerminalconductingList.add(conductingequipmentID);
    TerminalconnectList.add(connectivityNodeID);
    
	}
	return(TerminalconnectList);
}
}